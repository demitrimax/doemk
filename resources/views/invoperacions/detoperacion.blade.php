  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <span class="label label-success"> <i class="far fa-check-square"></i> Surtido en su Totalidad</span>
        @endif
        ...
        <span class="label label-warning"> <i class="far fa-check-square"></i> Surtido parcialmente ({{ number_format($detoperacion->parcial) }})</span>
