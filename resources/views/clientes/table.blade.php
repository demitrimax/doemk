        ...
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    ...
                    @can('clientes-edit')
                    <a href="{!! route('clientes.edit', [$clientes->id]) !!}" class='btn btn-primary'><i class="fa fa-pencil"></i></a>
                    @endcan
                    @can('clientes-delete')
                    {!! Form::button('<i class="fa fa-trash-o"></i>', ['type' => 'button', 'class' => 'btn btn-danger', 'onclick' => "ConfirmDelete($clientes->id)"]) !!}
                    @endcan
                </div>
                {!! Form::close() !!}
            </td>
